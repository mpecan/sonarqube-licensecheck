...
public class GradleProjectResolver {
    ...
    public static File prepareGradleProject() throws IOException {
        return prepareGradleProject("gradle");
    }

    public static File prepareGradleProject(String baseFolder) throws IOException {
        return ProjectResolver.prepareProject(() -> new File(GradleProjectResolver.class.getClassLoader().getResource(baseFolder + "/build.gradle").getPath()).getParentFile(), (projectRoot) -> {
